				...
				<form action="${pageContext.request.contextPath }/Register"
					...
					<table>
						<tr>
							...
							<td><input class="text" type="text" name="user_number"
						...
						<tr>
							...
							<td><input class="text" type="password" id="user_passWord"
						...
						<tr>
							...
							<td><input class="text" type="password"
								name="user_rePassWord" onfocus="FocusItem(this)"
								onblur="CheckItem(this);" required="required"
						...
						<tr>
							...
							<td><input name="user_sex" type="radio" value="男"
								checked="checked" />男&nbsp;&nbsp;<input name="user_sex"
								type="radio" value="女" />女</td>
						</tr>

						<tr>
							<td class="field">联系电话：</td>
							<td><input class="text" id="tel" name="User_phone"
								type="text" pattern="\d{11}" placeholder="请填入有效联系方式"
								title="请输入11位有效电话号码" /></td>
						</tr>
						<tr>
							<td class="field">地址：</td>
							<td><input class="text" type="text" name="user_adress"
								onfocus="FocusItem(this)" onblur="CheckItem(this);"
