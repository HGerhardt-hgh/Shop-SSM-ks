...
public class PhotoDao {
	...
	// 这个函数的功能是将文件传到预先设置的绝对路径中，也就是项目里的images文件夹
	public static boolean saveFile(FileItem item, String fileName) {
		// File savePath=new File("C:\\Users\\Lenovo\\Desktop\\新建文件夹
		// (3)\\2.0\\课程设计\\WebRoot\\images");
		File savePath = new File("D:\\code\\idea\\Shop-SSM\\out\\artifacts\\Shop_SSM_war_exploded\\images");
		if (!savePath.exists()) {
			savePath.mkdirs();
		}
